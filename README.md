# ✨ wonderful-triceratops-sanity-gatsby ✨
...
1. Get "stackbit-deploy (Read+Write)" API token from your [Sanity management console](https://manage.sanity.io/projects/qni3dzpq/settings/api)

1. Assign this access token to the `SANITY_DEPLOY_TOKEN` environment variable:

        export SANITY_DEPLOY_TOKEN={sanity_read_write_api_token}

1. Install the dependencies needed for the `stackbit-pull.js` script:

        npm install fs-extra@^6.0.1 lodash@^4.17.10 +(SANITY PACKAGE)
...
To start editing your site, you can use the Sanity interface at https://wonderful-triceratops-sanity-gatsby-ed372.sanity.studio/.
...
Generated at `2021-07-14T12:07:48.880Z` by Stackbit version `0.3.51`.